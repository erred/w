...
var isValidTimestamp = function (token) {
    var claims = decode(token).claims, now = Math.floor(new Date().getTime() / 1000);
...
var Sha1 = /** @class */ (function () {
     ...
     * @private
     */
    Sha1.prototype.compress_ = function (buf, optOffset) {
        if (!optOffset) {
            optOffset = 0;
        }
        var W = this.W_;
    ...
    Sha1.prototype.update = function (bytes, optLength) {
        ...
        var lengthMinusBlock = optLength - this.blockSize;
        var n = 0;
